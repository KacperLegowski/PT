...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        TableColumn<SendFileTask, String> fileNameColumn = new TableColumn<>("Nazwa");
        ...
        TableColumn<SendFileTask, Double> fileProgressColumn = new TableColumn<>("Postęp");
    ...
    private void sendFiles(ActionEvent event) {
        ...
        taskList.parallelStream()
                .forEach((task) -> task.setStatus("W kolejce..."));
        taskList.parallelStream()
